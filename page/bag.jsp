...
<body>
  ...
  <%
  String sql5="SELECT * FROM product WHERE id=2";
  ...
  <div class="list" id="商品內容">
    <br>
    <h2> 規格</h2>
    <h3 id="tab1">尺寸：26 × 18 × 4.5cm<br>
      材質：12oz帆布<br>
      顏色：藍 ／ 深棕 ／ 白（原胚色）<br>
      特色：銀色金屬拉鍊，內車縫布標可簽名。<br>
  ...
  <%
             sql="SELECT * FROM `guestbook` WHERE `Product`='萬用收納袋'"; 
             ...
             sql="SELECT * FROM `guestbook` WHERE `Product`='萬用收納袋' ORDER BY `GBNO` DESC LIMIT ";
             sql+=start_record+",5";
