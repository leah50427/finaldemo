...
<body>
  ...
  <%
  String sql5="SELECT * FROM product WHERE id=4";
  ...
  <%
             sql="SELECT * FROM `guestbook` WHERE `Product`='筆袋'"; 
             ...
             sql="SELECT * FROM `guestbook` WHERE `Product`='筆袋' ORDER BY `GBNO` DESC LIMIT ";
             sql+=start_record+",5";
