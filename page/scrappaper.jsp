...
<body>
  ...
  <%
  String sql5="SELECT * FROM product WHERE id=8";
  ...
  <%
             sql="SELECT * FROM `guestbook` WHERE `Product`='撕頁便條紙'"; 
             ...
             sql="SELECT * FROM `guestbook` WHERE `Product`='撕頁便條紙' ORDER BY `GBNO` DESC LIMIT ";
             sql+=start_record+",5";
