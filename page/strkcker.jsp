...
<body>
  ...
  <%
  String sql5="SELECT * FROM product WHERE id=7";
  ...
  <div class="row">
    ...
    <div class="right">
      ...
      <br>
      <h3 style="font-size: 16px;">簡單美化每個小小物件!</h3><br>
  ...
  <%
             sql="SELECT * FROM `guestbook` WHERE `Product`='透明霧面貼紙'"; 
             ...
             sql="SELECT * FROM `guestbook` WHERE `Product`='透明霧面貼紙' ORDER BY `GBNO` DESC LIMIT ";
             sql+=start_record+",5";
