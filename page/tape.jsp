...
<body>
  ...
  <%
  String sql5="SELECT * FROM product WHERE id=6";
  ...
  <div class="list" id="商品內容">
    <br>
    <h2>商品內容</h2>
    <h3>動物紙膠帶， 使用細緻的日本和紙製作，陪你渡過每個厭世日常!</h3>
    <h2> 規格</h2>
    <h3 id="tab1">尺寸：紙膠帶寬 2cm<br>
      材質：日本和紙<br>
      特色：手寫字與手繪圖。<br>
    </h3>
  </div>
  ...
  <%
             sql="SELECT * FROM `guestbook` WHERE `Product`='動物紙膠帶'"; 
             ...
             sql="SELECT * FROM `guestbook` WHERE `Product`='動物紙膠帶' ORDER BY `GBNO` DESC LIMIT ";
             sql+=start_record+",5";
